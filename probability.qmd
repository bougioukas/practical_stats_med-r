...
#| fig-cap: The complement of the union of A and B as represented in a Venn diagram.
...
3.  If A and B are two mutually exclusive events (also known as disjoint events), then **P(A ∪ B) = P(A) + P(B)** and **P(A ∩ B) = 0**.
:::


### Definition of Probability

#### _A. Theoretical probability (theoretical approach)_
...
#### _B. Experimental probability (frequentist approach)_
...
#### _C. "Subjective" probability (Bayesian approach)_
