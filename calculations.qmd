...
Scientific notation is a special way of expressing numbers that are too big or too small to be conveniently written in decimal form. Generally, it expresses numbers in forms of $m \times 10^n$ and R uses the **e** notation[^calculations-1].

[^calculations-1]: **NOTE:** that the *e* notation has nothing to do with the Euler's number *e=2.718*.
