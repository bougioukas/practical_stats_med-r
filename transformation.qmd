...
#### _B. Select observations by indexing with conditions within the square brackets_
...
#### _C. Select observations using the `subset()` function_
...
#### _D. Select observations using the `filter()` function from `{dplyr}` package_
...
#### _A. Select or exclude variables by indexing their name within square brackets_
...
#### _B. Select or exclude variables by indexing position within square brackets (not recommended)_
...
#### _C. Select variables using the `subset()` function_
...
#### _D. Select variables using the `select()` function from `{dplyr}` package_
