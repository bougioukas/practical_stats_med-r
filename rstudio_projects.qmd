...
### Organizing our RStudio Project folder

Files on our computer are organized into folders. Similarly, RStudio project folders and files can be managed in the same manner as we typically handle folders and files on our computer.
