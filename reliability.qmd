...
Based on the @eq-score the "true score" is μ + ID and the measurement error is M + Residual.
:::
...
In test-retest reliability analysis there are only two measurements (Measurement 1 and Measurement 2; see @tbl-icc) at different time points, so k = 2.
:::
...
The percent of observed overall agreement is 0.25 + 0.35 = 0.60. The distribution of marginal totals of question Q4 is **asymmetrical** (opposite direction) and **imbalanced** (f1 = 0.70 and f2 = 0.30 deviate greatly from 0.5).
