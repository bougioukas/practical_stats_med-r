...
The difference between the point estimate and the population parameter is called the **error** in the estimate. This error is a "total" error, and it consists of two components:
